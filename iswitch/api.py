...
def create_order():
    ...
    try:
        ...
        #     payload = {
        #         "ver": "1.0",
        #         "hdnOrderID": str(uuid.uuid4()),
        #         "mid": processor.get_password("client_id"),
        #         "merchantVpa": "AnshikaFintech@appl",
        #         "customerVpa": data.get("vpa")
        #     }
        ...
        #     url = processor.api_endpoint.rstrip("/") + "/upivaladd"
        ...
        #         frappe.log_error("Validation Response", api_data)
        #         if api_data.get("meta" ,None):
        #             response = {
        #                 "code": "0x0500",
        #                 "status": "Validation Error",
        #                 "message": "Error in vpa validation"
        #             }
        #             request_response = frappe.get_doc("Request Response", request_response.name)
        #             request_response.response = json.dumps(response)
        #             request_response.submit()
        ...
        #         frappe.log_error(f"Error in vpa validation {api_response.text}",str(e))
        #         frappe.db.rollback(save_point = "start_transaction")
        #         response = {
        #             "code": "0x0400",
        #             "status": "VALIDATION_ERROR", 
